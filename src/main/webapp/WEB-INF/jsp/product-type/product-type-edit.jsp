                ...
                <div style="width:50%;">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input value="${requestScope.productType.productType }" type="text" class="form-control" id="productType" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="generateBuyNo" class="col-sm-2 control-label"><span class="required-span">*</span> 代买编码：</label>
                            <div class="col-sm-10">
                                <input value="${requestScope.productType.generateBuyNo }" type="text" class="form-control" id="generateBuyNo" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="generateSellNo" class="col-sm-2 control-label"><span class="required-span">*</span> 代卖编码：</label>
                            <div class="col-sm-10">
                                <input value="${requestScope.productType.generateSellNo }" type="text" class="form-control" id="generateSellNo" />
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
	                            ...
	                            <button type="button" onclick="update();" class="btn btn-sm button-common">更&nbsp;&nbsp;新</button>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript">
	function update() {
	    ...
	    var params = {};
	    params.id = '${requestScope.productType.id}';
